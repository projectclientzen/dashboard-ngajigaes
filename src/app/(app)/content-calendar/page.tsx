  ...
  return (
    <div className="bg-white border border-[#EBE5D4] rounded-lg p-10 flex flex-col items-center text-center gap-3">
      ...
      <div className="text-[13px] text-[#9A9279] max-w-[420px] leading-relaxed">
        Kalender + list konten dengan badge status &amp; validasi, form konten lengkap (hook, CTA, caption, PIC, publish date),
        dan input insight saat published. Siap dibangun di iterasi berikutnya.
      </div>
    </div>
  )
}
